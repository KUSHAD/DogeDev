...
export default function ReceiptPDF({ data }) {
	...
	return (
		<Document
			...
			subject={`${data?.type} from ${data?.name} of Rupees ${ammount}`}
			title={`${data?.type} from ${data?.name} of Rupees ${ammount}`}
		>
				...
				<View style={styles.body}>
					<View style={styles.bodyInner}>
						...
						<Text>
							...
							<Text style={styles.vars}>{data?.name}</Text> (Identity /Phone
							Number : <Text style={styles.vars}>{data.ph}</Text> ) the sum of
							rupees <Text style={styles.vars}>{ammount}</Text> in account of{' '}
							<Text style={styles.vars}>{data?.desc}</Text> by{' '}
